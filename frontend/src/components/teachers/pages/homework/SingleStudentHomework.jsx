...
function SingleStudentHomework({ student, studentsSelected, changed }) {
    ...
    return (
        <tr className={studentsSelected.includes(student.id) ? "clicked" : ""}>
            ...
            <td className='attendence'>
                <div>
                    <button className='present'>Voir</button>
                    <button className='absent'>Annuler</button>
                </div>
            </td>
...
export default SingleStudentHomework